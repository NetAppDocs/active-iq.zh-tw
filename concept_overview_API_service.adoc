...
兩種檢視都允許使用者使用左側的導覽窗格瀏覽可用項目。項目按服務名稱和字母順序排列。在特定服務下，您可以擴充標題以顯示各個 API 端點。選擇服務標題或 API 端點將帶您進入中間窗格中對應的目錄部分。
...
有關如何存取和使用 Digital Advisor API 的資訊，請參閱 link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor API 文件"]。
