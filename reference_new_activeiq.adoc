...
Active IQ Digital Advisor正在更改為Digital Advisor ，並且現在已整合到BlueXP（NetApp 用於混合多雲環境的統一管理控制台）中。link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["深入瞭解"] 。
...
* *規劃小工具：*
+
** *容量增加：* 對於任何容量使用率超過現有容量 70% 的 GRID 站點，您將收到通知。如果容量使用率可能超過 70%，您可以選擇在未來 1 個月、3 個月和 6 個月內為該站點的 StorageGRID 增加容量。
