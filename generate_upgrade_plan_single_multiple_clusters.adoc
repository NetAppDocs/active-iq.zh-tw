...
* 確保已啟用並正確配置AutoSupport（ASUP），並且包含所有必要的部分。有關詳細信息，請參閱 link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["ONTAPAutoSupport解決方案指南"]。
