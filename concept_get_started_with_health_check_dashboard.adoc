...
* *AutoSupport 採用率*：顯示已啟用 AutoSupport 的系統數量和百分比。您也可以檢視標記為「已拒絕」的系統、已啟用 *HTTPS* 和 *AutoSupport on Demand* 的系統，以及 *訊號遺失* 的系統（即過去 7 天內停止傳送 AutoSupport 資料的系統）。若要檢視您的資訊健檢評分及安裝基礎中系統的相關資訊，請按一下 *AutoSupport 採用率* 小工具。
