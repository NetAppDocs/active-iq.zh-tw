...
----
+
如需有關 ansible-galaxy 命令的詳細資訊，請參閱 link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Ansible銀河文件"^]，如需有關 NetApp Ansible Collection 的詳細資訊，請參閱 link:https://galaxy.ansible.com/netapp/ontap["NetApp Ansible收藏頁面"^]。
